    ...
    <>
      <style>{`
        *, *::after, *::before {
        ...
        .flower--2 { left: 50%; transform: rotate(30deg); animation: moving-flower-2 4s linear infinite; }
      ...
      <div className="flowers">
        ...
        {[0, 1, 2, 3, 4, 5, 6, 7].map((gi) => {
          ...
          return (
            <div key={gi} className={`long-g long-g--${gi}`}>
              {[0, 1, 2, 3].map((li) => (
                <div
                  key={li}
                  className="grow-ans"
                  style={{ "--d": delays[gi][li] } as React.CSSProperties}
                >
